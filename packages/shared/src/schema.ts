...
/**
 * The fixed node id behind the read-only "live demo" the web app boots at "/" (see
 * useOrbisController's DEMO_ROOT_ID usage). Shared so the server can refuse to delete it - the app
 * itself, not any per-user data, would break if this id (or a descendant of it) were ever removed.
 */
export const DEMO_ROOT_ID = "ed2e2fd90cc040bc8b11ddf969a8a731";
